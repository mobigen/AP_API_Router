...
from Utils.elasticsearch_utils import make_query
...
class ElasticSearchManager:
    ...
    def insert(self, body: dict, doc_id: str):
    ...
    def put_index(self, root_path):
        file_path = root_path + f"/ELKSearch/conf/mapping/{self.index}.json"
        with open(file_path, "r") as fp:
            mapping = json.load(fp)

        self.conn.indices.create(index=self.index, body=mapping)
